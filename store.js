...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/ashenoak/"
    })
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: "https://listalous.herokuapp.com/lists/ashenoak/items",
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: "https://listalous.herokuapp.com/lists/ashenoak/items/" + itemId,
  ...
  deleteItem: function(itemId) {
    ...
    deleteRequest.done(function(result) {
      ...
      var itemIndex = items.findIndex(getIndex)
